...
<img src="../assets/img/image-20250527134258276.png" alt="image-20250527134258276" />

**图 1**：区块数据的层级结构，展示了区块哈希的“双重 Merkle 构造”。每个切片（slice）都有一个 Merkle 根哈希 $r_i$，这些根哈希又作为第二棵 Merkle 树的叶节点，其根节点就是该区块的哈希值。
